  ...
  return (
    <div className={`app-container ${darkMode ? "dark" : ""}`}>
      ...
      <style>{`
        ...
        .download-btn:hover { background: #a5a4a4ff; }
        ...
        .dark .data-table th { background: #e0e0e0; color: #000; }
        .data-table td {
          padding: 8px;
          border-bottom: 1px solid #ccc;
        }
        .data-table tr:nth-child(even) { background-color: rgba(0,0,0,0.03); }
        .dark .data-table tr:nth-child(even) { background-color: rgba(255,255,255,0.05); }
      `}</style>
    </div>
  );
}
